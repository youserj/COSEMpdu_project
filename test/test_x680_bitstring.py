...
class TestBitStringType(unittest.TestCase):
    ...
    def test_empty_zeros_ones(self) -> None:
    ...
    def test_bit_length_and_octet_length(self) -> None:
    ...
    def test_getitem_str_with_named_bits(self) -> None:
    ...
    def test_str_without_named_bits(self) -> None:
    ...
    def test_str_with_named_bits(self) -> None:
...
class TestInheritance(unittest.TestCase):
    ...
    def test_different_types_different_names(self) -> None:
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_empty_bit_string(self) -> None:
    ...
    def test_very_long_bit_string(self) -> None:
    ...
    def test_bit_operations_with_different_lengths(self) -> None:
    ...
    def test_named_bit_out_of_range(self) -> None:
